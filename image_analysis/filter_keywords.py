#!/usr/bin/env python3
"""
Script to remove top 10 most frequent keywords from artistic_analysis.json
"""
...
def main():
    """Main function"""
    input_file = "artistic_analysis.json"
    output_file = "artistic_analysis_filtered.json"
