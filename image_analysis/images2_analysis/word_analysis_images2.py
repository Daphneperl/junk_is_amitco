...
class ArtisticImageAnalyzer:
    def __init__(self, images_folder: str, output_file: str = "artistic_analysis_images2.json"):
        """
...
def main():
    ...
    # Configuration
    images_folder = "images2"  # Path to images2 folder
    output_file = "image_analysis/images2_analysis/artistic_analysis_images2.json"  # Output file name for images2 analysis
